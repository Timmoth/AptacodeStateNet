...
namespace StateNet.Tests.Network.Helpers
{
    public static class StateNetwork_Helpers
    {
        ...
        public static StateNetwork Invalid_StartState_Network =>
            new("c", StateNetworkDictionary_Helpers.Minimal_Valid_Connected_StaticWeight_NetworkDictionary,
        ...
        public static StateNetwork Invalid_ConnectionTargetState_Network =>
            new("a", StateNetworkDictionary_Helpers.Invalid_ConnectionTargetState_NetworkDictionary,
                new Pattern[0]);

        public static StateNetwork Invalid_ConnectionPatternState_Network =>
            new("a", StateNetworkDictionary_Helpers.Invalid_ConnectionPatternState_NetworkDictionary,
                new Pattern[0]);

        public static StateNetwork Invalid_ConnectionPatternInput_Network =>
            new("a", StateNetworkDictionary_Helpers.Invalid_ConnectionPatternInput_NetworkDictionary,
                new Pattern[0]);
        ...
        public static StateNetwork Empty_Network =>
            new("", StateNetworkDictionary_Helpers.Empty_NetworkDictionary, new Pattern[0]);

        public static StateNetwork Invalid_Unreachable_State_Network =>
            new("a", StateNetworkDictionary_Helpers.Invalid_Unreachable_State_NetworkDictionary,
                new Pattern[0]);

        public static StateNetwork Invalid_UnusableInput_Network =>
            new("a", StateNetworkDictionary_Helpers.Invalid_UnusableInput_NetworkDictionary,
                new Pattern[0]);
    }
}